      ...
      <section className="relative overflow-hidden border-b border-ink-200">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <p className="caption text-clay-700 mb-4">Contact</p>
            ...
            {contactMethods.map((method) => (
              ...
              >
                <CardContent className="pt-6">
                  ...
                  <a
                    href={method.href}
                    className="inline-flex items-center justify-center rounded-md border border-clay-300 bg-white px-4 py-2 text-sm font-medium text-clay-700 transition-colors hover:bg-clay-50"
                  >
                    {method.action}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl">
            <div className="text-center mb-12">
              <p className="caption text-clay-700 mb-4">FAQ</p>
